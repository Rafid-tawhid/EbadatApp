...
package com.abc.sharefilesz.migration.db;
...
import com.abc.sharefilesz.migration.db.object.TransferAssigneeV12;
import com.abc.sharefilesz.migration.db.object.TransferObjectV12;
import com.abc.sharefilesz.migration.db.object.WritablePathObjectV12;
...
public class Migration
{
    public interface v12
    {
        ...
        static SQLValues tables(SQLValues currentValues)
        {
            ...
            values.defineTable(Kuick.TABLE_TRANSFER)
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFER_ID, SQLType.LONG, false))
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFER_GROUPID, SQLType.LONG, false))
                    .define(new SQLValues.Column(v12.FIELD_TRANSFER_DEVICEID, SQLType.TEXT, true))
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFER_FILE, SQLType.TEXT, true))
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFER_NAME, SQLType.TEXT, false))
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFER_SIZE, SQLType.INTEGER, true))
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFER_MIME, SQLType.TEXT, true))
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFER_TYPE, SQLType.TEXT, false))
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFER_DIRECTORY, SQLType.TEXT, true))
                    ...
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFER_FLAG, SQLType.TEXT, true));

            // define the transfer division table based on the transfer table
            SQLValues.Table transferTable = values.getTables().get(Kuick.TABLE_TRANSFER);
            ...
            values.defineTable(Kuick.TABLE_TRANSFERASSIGNEE)
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFERASSIGNEE_GROUPID, SQLType.LONG, false))
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFERASSIGNEE_DEVICEID, SQLType.TEXT, false))
                    .define(new SQLValues.Column(Kuick.FIELD_TRANSFERASSIGNEE_CONNECTIONADAPTER, SQLType.TEXT, true))
    ...
    public static void migrate(Kuick kuick, SQLiteDatabase db, int old, int current)
    {
        ...
        switch (old) {
            ...
            case 6:
                SQLValues.Table groupTable = tables12.getTable(Kuick.TABLE_TRANSFERGROUP);
                SQLValues.Table devicesTable = tables12.getTable(Kuick.TABLE_DEVICES);
                SQLValues.Table targetDevicesTable = tables12.getTable(Kuick.TABLE_TRANSFERASSIGNEE);
            ...
            case 10:
                ...
                try {
                    SQLValues.Table tableTransfer = tables12.getTable(Kuick.TABLE_TRANSFER);
                    ...
                    List<TransferAssigneeV12> availableAssignees = kuick.castQuery(db,
                            new SQLQuery.Select(Kuick.TABLE_TRANSFERASSIGNEE),
                            TransferAssigneeV12.class, null);
                    List<TransferObjectV12> availableTransfers = kuick.castQuery(db,
                            new SQLQuery.Select(Kuick.TABLE_TRANSFER), TransferObjectV12.class, null);
            ...
            case 11:
                SQLValues.Table tableFileBookmark = tables12.getTable(Kuick.TABLE_FILEBOOKMARK);
                SQLQuery.createTable(db, tableFileBookmark);
            case 12:
                List<TransferGroup> totalGroupList = kuick.castQuery(db, new SQLQuery.Select(
                        Kuick.TABLE_TRANSFERGROUP), TransferGroup.class, null);
                SQLValues.Table tableTransferGroup = tables12.getTable(Kuick.TABLE_TRANSFERGROUP);
            ...
            case 13: {
                {
                    SQLValues.Table table = tables.getTable(Kuick.TABLE_DEVICES);
                    SQLValues.Column typeColumn = table.getColumn(Kuick.FIELD_DEVICES_TYPE);
                    SQLValues.Column clientVerCol = table.getColumn(Kuick.FIELD_DEVICES_CLIENTVERSION);
...

                {
                    List<TransferAssigneeV12> oldList = kuick.castQuery(db, new SQLQuery.Select(
                            Kuick.TABLE_TRANSFERASSIGNEE), TransferAssigneeV12.class, null);

                    // Added: Type, Removed: IsClone
                    db.execSQL("DROP TABLE IF EXISTS `" + Kuick.TABLE_TRANSFERASSIGNEE + "`");
                    SQLQuery.createTable(db, tables.getTable(Kuick.TABLE_TRANSFERASSIGNEE));
                    ...
                    for (TransferAssigneeV12 assigneeV12 : oldList) {
                        SQLQuery.Select selection = new SQLQuery.Select(Kuick.TABLE_TRANSFER);
                        selection.setWhere(Kuick.FIELD_TRANSFER_TYPE + "=? AND "
                                + Kuick.FIELD_TRANSFER_GROUPID + "=? AND " + v12.FIELD_TRANSFER_DEVICEID
                ...
                {
                    SQLValues.Table table = tables.getTable(Kuick.TABLE_TRANSFER);
                    ...
                    List<TransferObjectV12> outgoingMirrorObjects = kuick.castQuery(db, new SQLQuery.Select(
                            Kuick.TABLE_TRANSFER).setWhere(Kuick.FIELD_TRANSFER_TYPE + "=?",
                    ...
                    db.execSQL("DROP TABLE IF EXISTS `" + Kuick.TABLE_TRANSFER + "`");
                ...
                {
                    SQLValues.Table table = tables.getTable(Kuick.TABLE_TRANSFERGROUP);
                    SQLValues.Column column = table.getColumn(Kuick.FIELD_TRANSFERGROUP_ISPAUSED);
