...
import static com.abc.sharefilesz.object.Identifier.from;
...
public class FileTransferTask extends AttachableBgTask<AttachedTaskListener>
{
    ...
    {
        return Identity.withANDs(Identifier.from(Id.GroupId, groupId));
    }

    public static Identity identifyWith(long groupId, TransferObject.Type type)
    {
        return Identity.withANDs(Identifier.from(Id.GroupId, groupId), Identifier.from(Id.Type, type));
    }

    public static Identity identifyWith(long groupId, String deviceId)
    {
        return Identity.withANDs(Identifier.from(Id.GroupId, groupId), Identifier.from(Id.DeviceId, deviceId));
    }

    public static Identity identifyWith(long groupId, String deviceId, TransferObject.Type type)
    {
        return Identity.withANDs(Identifier.from(Id.GroupId, groupId), Identifier.from(Id.DeviceId, deviceId), Identifier.from(Id.Type, type));
    }
