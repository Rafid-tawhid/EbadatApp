...
public class ConnectionUtils
{
    ...
    @WorkerThread
    public InetAddress establishHotspotConnection(Stoppable stoppable, NetworkDeviceListAdapter.NetworkDescription description)
    ...
    public ScanResult findFromScanResults(NetworkDeviceListAdapter.NetworkDescription description) throws SecurityException
    {
    ...
    public boolean isConnectedToNetwork(NetworkDeviceListAdapter.NetworkDescription description)
    {
    ...
    @TargetApi(29)
    public int suggestNetwork(NetworkDeviceListAdapter.NetworkDescription description)
    {
