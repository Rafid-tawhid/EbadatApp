...
import com.abc.sharefilesz.widget.recyclerview.PaddingItemDecoration;
import com.abc.sharefilesz.widget.recyclerview.SwipeSelectionListener;
        ...
        implements IEditableListFragment<T, V>
{
    ...
    private int mLayoutResId = R.layout.fragment_editablelist;
